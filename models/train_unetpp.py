...
# ============================================================================
IMAGE_SIZE = 512
BATCH_SIZE = 2                  # Conservative for tu-resnet34 + AMP (adjust based on VRAM)
EPOCHS = 50
...
# ============================================================================
# 2. VISUALIZATION & LOGGING UTILITIES 
# ============================================================================
...
# ============================================================================
def main():
    print(f"Hardware: {DEVICE} | Model: UNet++ (ResNet34 Backbone with AMP)")
    output_dir = 'unetpp_train_stats'
    os.makedirs(output_dir, exist_ok=True)
    ...
    # B. INITIALIZE UNET++ (Switched to ResNet34), OPTIMIZER, SCHEDULER, LOSS
    print("Initializing UNet++ with tu-resnet34 encoder...")
    try:
        ...
        print("Model loaded with pretrained imagenet weights successfully!")
    except Exception as e:
        print(f"Pretrained weights failed ({e}). Loading without pretrained weights...")
        model = smp.UnetPlusPlus(
            encoder_name="tu-resnet34", 
        ...
        print("Model loaded without pretrained weights.")
    ...
    # ============================================================================
    # 4. FINAL TESTING (Unseen Data)
    # ============================================================================
    print("\n--- Running Final Evaluation on Test Dataset ---")
    model.load_state_dict(torch.load("best_unetpp_model.pth"))
    model.eval()
    
    test_images_dir = "dataset/test/Color_Images"
    test_output_dir = "unetpp_test_predictions"
